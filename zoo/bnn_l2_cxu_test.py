## bnn_l2_cxu_test.py: bnn_l2_cxu (CXU-L2) testbench
...
def test_bnn_l2(request, width):
    ...
    run(
        includes=["."],
        verilog_sources=["common.svh", "cxu.svh", f"{dut}.sv", "cvt02_cxu.sv", "shared.sv", "bnn_cxu.sv", "popcount_cxu.sv"],
        toplevel=dut,
        module=module,
        parameters=parameters,
        defines=['BNN_L2_CXU_VCD'],
        extra_env={ 'CXU_N_STATES':str(0), 'CXU_DATA_W':str(width) },
        sim_build=sim_build
    )
