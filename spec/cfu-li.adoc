...
For `CFU_LI_VERSION` and `CFU_CFU_ID_MAX`, see §<<parameters>>.
...
For `CFU_LI_VERSION`, `CFU_CFU_ID_MAX`, and `CFU_STATE_ID_MAX`, see §<<parameters>>.
...
For `CFU_LI_VERSION`, `CFU_CFU_ID_MAX`, and `CFU_STATE_ID_MAX`, see
§<<parameters>>.
