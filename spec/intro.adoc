== Introduction: a composable extension ecosystem
...
The RISC-V Composable Extensions Specification introduces a
...
* a _composable extension (CX):_ a composable extension consisting of a set of _custom function (CF) instructions;_
